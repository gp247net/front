...
/**
 * Seed the admin/UI translation strings owned by gp247/front.
 *
 * Extracted from DataFrontDefaultSeeder so front's language rows can be reseeded
 * on their own, independently of the menu/banner/page/link data. Defaults to
 * insertOrIgnore: existing rows for the same (code, location) unique key are
 * kept, so it is safe to re-run. The gp247:language-update command flips it to
 * upsert via useUpsert().
 *
 * @aidlc-unit compat-foundation
 */
class DataFrontLanguageSeeder extends Seeder
{
    /**
    ...
    {
        if ($this->useUpsert) {
            Languages::upsert($rows, ['code', 'location'], ['text', 'position']);
        } else {
            Languages::insertOrIgnore($rows);
        }
    }

    /**
     * Seed front language rows. Skips existing (code, location) by default;
    ...
    public function run()
    {
        ...
        $this->writeLang(
            [
                ...
                ['code' => 'admin.layout_block.helper_view','text' => 'View files come from the active template — the package default or your published copy in "app/GP247/Templates/:template/blocks".','position' => 'admin.layout_block','location' => 'en'],
                ...
                ['code' => 'admin.layout_block.helper_view','text' => 'File lấy từ template đang dùng — bản mặc định của package hoặc bản bạn đã publish trong "app/GP247/Templates/:template/blocks".','position' => 'admin.layout_block','location' => 'vi'],
                ...
                ['code' => 'admin.layout_block.add_new','text' => 'Thêm khối bố cục mới','position' => 'admin.layout_block','location' => 'vi'],
                ['code' => 'admin.layout_block.add_new','text' => 'Add block layout','position' => 'admin.layout_block','location' => 'en'],
                ['code' => 'admin.layout_block.title','text' => 'Khối bố cục','position' => 'admin.layout_block','location' => 'vi'],
                ['code' => 'admin.layout_block.title','text' => 'Block layout','position' => 'admin.layout_block','location' => 'en'],
                ...
                ['code' => 'front.search','text' => 'Tìm kiếm','position' => 'front','location' => 'vi'],
        ...
        $this->writeLang([
            ...
            // Banner type
            ['code' => 'admin.banner_type.title',   'text' => 'Banner types',     'position' => 'admin.banner_type', 'location' => 'en'],
            ...
            ['code' => 'admin.link.type_collection', 'text' => 'Bộ sưu tập',       'position' => 'admin.link', 'location' => 'vi'],

            // Link group
            ['code' => 'admin.link_group.title',   'text' => 'Link groups',         'position' => 'admin.link_group', 'location' => 'en'],
        ...
        $this->writeLang([
            ...
            ['code' => 'front.seo.sitemap_title',   'text' => 'Sitemap',          'position' => 'front.seo', 'location' => 'en'],
            ['code' => 'front.seo.rebuild_sitemap', 'text' => 'Tạo lại sitemap', 'position' => 'front.seo', 'location' => 'vi'],
            ['code' => 'front.seo.rebuild_sitemap', 'text' => 'Rebuild sitemap', 'position' => 'front.seo', 'location' => 'en'],

            // Redirect
            ['code' => 'front.seo.redirect_from', 'text' => 'URL gốc',       'position' => 'front.seo', 'location' => 'vi'],
            ['code' => 'front.seo.redirect_from', 'text' => 'From URL',       'position' => 'front.seo', 'location' => 'en'],
            ['code' => 'front.seo.redirect_to',   'text' => 'URL đích',       'position' => 'front.seo', 'location' => 'vi'],
            ['code' => 'front.seo.redirect_to',   'text' => 'To URL',         'position' => 'front.seo', 'location' => 'en'],
            ['code' => 'front.seo.redirect_code', 'text' => 'Loại redirect',  'position' => 'front.seo', 'location' => 'vi'],
            ['code' => 'front.seo.redirect_code', 'text' => 'Redirect type',  'position' => 'front.seo', 'location' => 'en'],
        ]);
    }
}
