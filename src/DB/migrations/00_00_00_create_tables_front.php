...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $schema->create(
            GP247_DB_PREFIX.'front_banner_type',
            function (Blueprint $table) {
                $table->increments('id');
        ...
        $schema->create(
            GP247_DB_PREFIX.'front_store_block',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
                $table->string('name', 255);
        ...
        $schema->create(
            GP247_DB_PREFIX.'front_link_group',
            function (Blueprint $table) {
                $table->increments('id');
                $table->string('code', 100)->unique();
                $table->string('name', 255);
        ...
        $schema->create(
            GP247_DB_PREFIX.'front_page_description',
            function (Blueprint $table) {
                $table->uuid('page_id');
        ...
        $schema->create(
            GP247_DB_PREFIX.'front_subscribe',
            function (Blueprint $table) {
                $table->uuid('id')->primary();
    ...
    public function down()
    {
        ...
        $schema->dropIfExists(GP247_DB_PREFIX.'front_store_block');
