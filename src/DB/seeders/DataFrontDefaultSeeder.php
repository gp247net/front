    ...
    public function run()
    {
        ...
        Languages::insertOrIgnore(
            [
                ...
                ['code' => 'admin.layout_block.helper_view','text' => 'View files are in "resources/views/templates/:template/block" directory.','position' => 'admin.layout_block','location' => 'en'],
                ...
                ['code' => 'admin.layout_block.helper_view','text' => 'File trong thư mục "resources/views/templates/:template/block".','position' => 'admin.layout_block','location' => 'vi'],
