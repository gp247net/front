{{--
    SEO settings screen (US-SEO-004): robots.txt editor, sitemap inclusion
    toggles, wildcard alias exclusion list, manual "rebuild sitemap" action,
    and quick links to the live /robots.txt, /sitemap.xml and to the existing
    "Website info" screen for default meta/OG (deliberately not duplicated
    here — see modification 20260711T114155).
